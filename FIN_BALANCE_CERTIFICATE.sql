CREATE OR REPLACE PACKAGE        FIN_BALANCE_CERTIFICATE AS 

 PROCEDURE FIN_BALANCE_CERTIFICATE(	inp_str      IN  VARCHAR2,
			out_retCode  OUT NUMBER,
			out_rec      OUT VARCHAR2 );

END FIN_BALANCE_CERTIFICATE;
/


CREATE OR REPLACE PACKAGE BODY                                    FIN_BALANCE_CERTIFICATE AS
...
-------------------------------------------------------------------------------------
  ...
  select 
      ...
      where
        ...
        -- AND ADDRESS.ADDRESSCATEGORY LIKE '%Mailing%' --Mailing
         AND (ADDRESS.ADDRESSCATEGORY LIKE '%Mailing%' or
               ADDRESS.ADDRESSCATEGORY like '%Registered%')
...
-------------------------------------------------------------
     ...
     v_address1 CRMUSER.ADDRESS.ADDRESS_LINE1%type;
     v_address2 CRMUSER.ADDRESS.ADDRESS_LINE2%type;
     v_address3 CRMUSER.ADDRESS.ADDRESS_LINE3%type;
