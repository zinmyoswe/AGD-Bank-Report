CREATE OR REPLACE PACKAGE FIN_DAY_BOOK_SUMMARY_NEW AS 

  PROCEDURE FIN_DAY_BOOK_SUMMARY_NEW (	inp_str      IN  VARCHAR2,
			out_retCode  OUT NUMBER,
			out_rec      OUT VARCHAR2 );

END FIN_DAY_BOOK_SUMMARY_NEW;
/


CREATE OR REPLACE PACKAGE BODY                                                  FIN_DAY_BOOK_SUMMARY_NEW AS
