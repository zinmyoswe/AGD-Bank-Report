CREATE OR REPLACE PACKAGE FIN_ECOMMERCE_REVERSAL_LISTING AS

  /* TODO enter package declarations (types, exceptions, methods etc) here */
  PROCEDURE FIN_ECOMMERCE_REVERSAL_LISTING(	inp_str      IN  VARCHAR2,
                                            out_retCode  OUT NUMBER,
                                            out_rec      OUT VARCHAR2 );

END FIN_ECOMMERCE_REVERSAL_LISTING;

/


CREATE OR REPLACE PACKAGE BODY                      FIN_ECOMMERCE_REVERSAL_LISTING AS

/******************************************************************************
 NAME:       FIN_ECOMMERCE_REVERSAL_LISTING
 PURPOSE:
...
--------------------------------------------------------------------------------
-- CURSOR declaration FIN_ECOMMERCE_REVERSAL_LISTING CURSOR
--------------------------------------------------------------------------------
--------------------------------------------------------------------------------
-- CURSOR ExtractData
--------------------------------------------------------------------------------
...
IS
  ...
  (
      ...
      AND D.DEL_CHANNEL_MESG_ID = 'PRRS'
      AND D.TRAN_REMARKS = 'EComm'
      AND DTT.DTH_INIT_SOL_ID LIKE '%' || '' || '%'
...
IS
  ...
  BEGIN
    -- TODO: Implementation required for PROCEDURE FIN_ECOMMERCE_REVERSAL_LISTING.FIN_ECOMMERCE_REVERSAL_LISTING
    ------------------------------------------------------------------------------
