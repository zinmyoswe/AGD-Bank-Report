CREATE OR REPLACE PACKAGE                FIN_FCY_BUYING
AS
PROCEDURE FIN_FCY_BUYING(	inp_str      IN  VARCHAR2,
...
CREATE OR REPLACE PACKAGE BODY                                                        FIN_FCY_BUYING AS
...
and trim(deno.FOREIGN_EXCHANGE) = 'B'
and deno.del_flg = 'N'
