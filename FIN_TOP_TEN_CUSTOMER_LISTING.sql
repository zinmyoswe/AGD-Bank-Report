CREATE OR REPLACE PACKAGE        FIN_TOP_TEN_CUSTOMER_LISTING AS 
PROCEDURE FIN_TOP_TEN_CUSTOMER_LISTING(	inp_str      IN  VARCHAR2,
			out_retCode  OUT NUMBER,
			out_rec      OUT VARCHAR2 );
  

END FIN_TOP_TEN_CUSTOMER_LISTING;
/


CREATE OR REPLACE PACKAGE BODY                                         FIN_TOP_TEN_CUSTOMER_LISTING AS  
/******************************************************************************
 NAME:      FIN_TOP_TEN_CUSTOMER_LISTING
 PURPOSE:
